...
This folder contains the final project completed as part of the Software Testing Internship. The objective of this project was to perform end-to-end testing on a web application and document all testing activities in a structured and professional manner and also includes final summary report of the internship.

PROJECT OVERVIEW:
- The selected application for testing is an E-commerce website: Demoblaze
...
The following documents are included in this project:
   ...
   - Bug Report – List of identified defects (10+)
   - Screenshots – Evidence of bugs and testing
